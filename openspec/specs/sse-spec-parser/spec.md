# sse-spec-parser Specification

## Purpose
Spec-compliant SSE stream parser that replaces the naive hand-rolled parser in the main process. Handles multi-line data concatenation, chunk-boundary splits, and properly ignores id/retry/comment fields per the WHATWG SSE specification.
