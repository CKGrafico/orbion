...
- [ ] 1.2 Update the SSH probe to detect the loop-task command and require Node.js 20 or newer <!-- agent: frontend-engineer.build, depends_on: [1.1], touches: [src/main/ssh-probe.ts] -->
- [ ] 2.1 Preserve remote stdout, stderr, and installer or daemon log output in loop-task launch failures <!-- agent: frontend-engineer.build, depends_on: [1.1], touches: [src/main/ssh-launch.ts] -->
