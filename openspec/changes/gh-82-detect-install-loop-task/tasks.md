...
- [x] 2.2 Add the explicit missing-loop-task install-and-start checkpoint to the SSH wizard while leaving local onboarding unchanged <!-- agent: frontend-engineer.build, depends_on: [1.2, 2.1], touches: [src/main/vm-wizard.ts] -->
