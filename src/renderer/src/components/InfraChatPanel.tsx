...
import type { InfraActionArgs, MachineStatusEntry, CreateIssueResult, ListIssuesResult, AddLabelResult, EditIssueResult, WatchTarget, WatchCondition } from "../../../shared/ipc";
