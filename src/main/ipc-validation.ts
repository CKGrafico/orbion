...
const INFRA_ACTIONS = ["machine-status", "clone-repo", "create-issue", "detect-platform", "list-issues", "add-label", "edit-issue", "bulk-relabel", "list-prs-awaiting-review"] as const;
